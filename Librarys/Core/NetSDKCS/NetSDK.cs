...
namespace NetSDKCS
{
  public static class NETClient
  {
    ...
    {
      //var dllDir = Environment.Is64BitProcess ? "Win64" : "Win86";
      //var netsdk = System.IO.Path.Combine(System.IO.Directory.GetCurrentDirectory(), dllDir, "dhnetsdk.dll");
      //var configsdk = System.IO.Path.Combine(System.IO.Directory.GetCurrentDirectory(), dllDir, "dhconfigsdk.dll");
      //IntPtr intPtr= LoadLibrary(netsdk);
      //IntPtr intPtr1 = LoadLibrary(configsdk);
      bool result = false;
