...
namespace NetSDKCS
{
  internal static class OriginalSDK
  {
...
#else
    const string LIBRARYNETSDK = "Win64/dhnetsdk.dll";
    const string LIBRARYCONFIGSDK = "Win64/dhconfigsdk.dll";
#endif
    ...
    [DllImport(LIBRARYNETSDK, CharSet = CharSet.Unicode)]
  ...
  fDataCallBack fDownLoadDataCallBack, IntPtr dwDataUser, IntPtr pReserved);
    ...
    [DllImport(LIBRARYCONFIGSDK, CharSet = CharSet.Unicode)]
